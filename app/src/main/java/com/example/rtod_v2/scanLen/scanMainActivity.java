package com.example.rtod_v2.scanLen;
...
public class scanMainActivity extends AppCompatActivity {
    ...
    private static final String TAG = "ERROR! scanMainActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchResultsRVAdapter = new SearchResultsRVAdapter(dataModalArrayList, scanMainActivity.this);

        LinearLayoutManager manager = new LinearLayoutManager(scanMainActivity.this, LinearLayoutManager.HORIZONTAL, false);
...
//                startActivityForResult(takePictureIntent, REQUEST_IMAGE_CAPTURE);
    ...
    private void getResults() {
        ...
        labeler.processImage(image).addOnSuccessListener(new OnSuccessListener<List<FirebaseVisionImageLabel>>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(scanMainActivity.this, "Fail to detect image..", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void searchData(String searchQuery) {
        ...
        RequestQueue queue = Volley.newRequestQueue(scanMainActivity.this);
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                // displaying error message.
                Toast.makeText(scanMainActivity.this, "No Result found for the search query..", Toast.LENGTH_SHORT).show();
            }
        });
